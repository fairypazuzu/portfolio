...
#строим части ссылки на основании запроса
                        ...
                        for wc_site_type in wc_site_types:
                            for repair_type in repair_types:
                                try:
                                    ...
                                    driver.get(link)
                                    #считаем количество квартир, страниц
                                    ...
                                    while page<total_pages:
                                        ...
                                        for x in [0, 1, 2]:
                                            for y in [0, 1, 2, 3, 4]:
                                                #с помощью регулярных выражений собираем данные об объектах недвижимости
